<template>
    <div id="testimonial" class="card container my-5 py-5 shadow-lg">
        ...
        <div class="untree_co-section" id="testimonials-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 mb-5 text-center text-lg-left mb-lg-0 aos-init aos-animate" data-aos="fade-up"
                        data-aos-delay="0">
                        <div class="mb-4">
                    ...
                    <div class="col-lg-8 aos-init aos-animate" data-aos="fade" data-aos-delay="200">
                        <div class="owl-2-slider owl-carousel owl-loaded owl-drag">
                            ...
                            <div class="owl-stage-outer owl-height" style="height: 193.969px;">
                                <div class="owl-stage"
                                    style="transform: translate3d(-1540px, 0px, 0px); transition: all 0.7s ease 0s; width: 2695px;">
                                    <div class="owl-item cloned" style="width: 345px; margin-right: 40px;">
                                        <div class="item">
                                            <div class="untree_co-testimonial d-flex">
                                                <div class="text">
                                                    <blockquote>
                                                        “Separated they <span class="highlight">live in Bookmarksgrove
                                                            right at the coast of the Semantics</span>, a large language
                                    ...
                                    <div class="owl-item" style="width: 345px; margin-right: 40px;">
                                        <div class="item">
                                            <div class="untree_co-testimonial d-flex">
                                                <div class="text">
                                                    <blockquote>
                                    ...
                                    <div class="owl-item active" style="width: 345px; margin-right: 40px;">
                                        <div class="item">
                                            <div class="untree_co-testimonial d-flex">
                                                <div class="text">
                                                    <blockquote>
                                    ...
                                    <div class="owl-item cloned active" style="width: 345px; margin-right: 40px;">
                                        <div class="item">
                                            <div class="untree_co-testimonial d-flex">
                                                <div class="text">
                                                    <blockquote>
                                                    ...
                                                    <div class="author d-flex">
                                                        <div class="pic mr-3">
                                                            <img src="https://preview.colorlib.com/theme/launch/images/person_3.jpg"
                                                                alt="Image" class="img-fluid">
                                                        </div>
                                                        <div>
                                                            <strong class="d-block">James Anderson</strong><span
