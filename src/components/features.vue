    ...
    <div id="feat" class="container my-5">
        ...
        <div class="row py-4 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
            ...
            <div class="col-lg-6 offset-lg-1 p-0 shadow-lg">
                <a href="https://www.youtube.com/watch?v=mwtbEGNABWU&t=9s"><img class="rounded-lg-3"
                        src="https://preview.colorlib.com/theme/launch/images/dashboard.jpg" alt=""
                        width="720"></a>
            </div>

            <!-- slideshow -->
            <div class="untree_co-section bg-light border">
                <div class="container">
                            ...
                            <div class="img-shadow">
                                <div class="owl-single no-dots owl-carousel">
                                    <div class="item">
                                        ...
                                        <img src="https://preview.colorlib.com/theme/launch/images/dashboard.jpg"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4 mb-lg-0 col-lg-3" data-aos="fade-up" data-aos-delay="100">
                            <div class="service">
                                <div class="service-icon color-2 mb-4">
                                    <svg class="bi bi-arrow-repeat" width="1em" height="1em"
                                        viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                                            d="M2.854 7.146a.5.5 0 0 0-.708 0l-2 2a.5.5 0 1 0 .708.708L2.5 8.207l1.646 1.647a.5.5 0 0 0 .708-.708l-2-2zm13-1a.5.5 0 0 0-.708 0L13.5 7.793l-1.646-1.647a.5.5 0 0 0-.708.708l2 2a.5.5 0 0 0 .708 0l2-2a.5.5 0 0 0 0-.708z" />
                                        <path fill-rule="evenodd"
